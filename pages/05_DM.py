...
st.set_page_config(page_title="DM", layout="wide")

st.title("DM Scheduling")

protocol = render_sidebar("DM", show_protocol=True) or "None"
...
if st.button("Generate DM schedule"):
    ...
    segments = simulate_uniprocessor(rows, int(range_end), "DM", protocol, resource_order)
